...
function funct1() {
  ...
  for (let i = 0; i <= klas1.length; i++) klas1[i].style.color = "orange";
}
...
function funct2() {
  ...
  for (let i = 0; i <= klas2.length; i++) klas2[i].style.color = "orange";
}
...
function funct3() {
  ...
  for (let i = 0; i <= klas3.length; i++) klas3[i].style.color = "orange";
}
...
function funct4() {
  ...
  for (let i = 0; i <= klas4.length; i++) klas4[i].style.color = "orange";
}
